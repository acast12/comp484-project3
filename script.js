...
window.addEventListener('DOMContentLoaded', highlightListItems);
...
document.getElementById('toggle-button').addEventListener('click', toggleStatus);
...
document.getElementById('timer-button')
  .addEventListener('click', startFlashing);

document.getElementById('timer-button')
  .addEventListener('dblclick', stopFlashing);
